import { C as __runInitializers, S as __esDecorate, u as serializeAsColor3, v as serializeAsVector3 } from "./decorators.serialization-BjNL6YoI.js";
import { o as Vector3, t as Matrix } from "./math.vector.pure-Cy3Wrv5e.js";
import { n as RegisterClass } from "./typeStore-BlCun_gy.js";
import { t as Color3 } from "./math.color.pure-CLc51uK4.js";
import { t as Node } from "./node-CZYoPoMy.js";
import { t as Light } from "./light-CvyK8hip.js";
//#region node_modules/@babylonjs/core/Lights/hemisphericLight.pure.js
	...
	return _a = class HemisphericLight extends _classSuper {
		...
		*/
		constructor(name, direction, scene, dontAddToScene) {
			...
			*/
			this.groundColor = __runInitializers(this, _groundColor_initializers, new Color3(0, 0, 0));
			/**
		...
		*/
		...
		__esDecorate(null, null, _groundColor_decorators, {
			kind: "field",
			name: "groundColor",
			static: false,
			private: false,
			access: {
				has: (obj) => "groundColor" in obj,
				get: (obj) => obj.groundColor,
				set: (obj, value) => {
					obj.groundColor = value;
				}
			},
			metadata: _metadata
		}, _groundColor_initializers, _groundColor_extraInitializers);
		__esDecorate(null, null, _direction_decorators, {
			kind: "field",
			name: "direction",
			static: false,
			private: false,
...
*/
function RegisterHemisphericLight() {
...
//#endregion
export { HemisphericLight, RegisterHemisphericLight };
