import { C as __runInitializers, S as __esDecorate, d as serializeAsColor4, l as serialize, t as SerializationHelper } from "./decorators.serialization-BjNL6YoI.js";
import { a as Vector2, f as Observable, o as Vector3 } from "./math.vector.pure-Cy3Wrv5e.js";
import { n as RegisterClass, o as ILog2, t as GetClass } from "./typeStore-BlCun_gy.js";
import { s as Logger } from "./guid-H658ONbr.js";
import { f as GetBlobBufferSource } from "./fileTools.pure-Dhr2LAZd.js";
import { c as InternalTexture, d as IsExponentOfTwo, l as Effect, s as AbstractEngine, u as GetExponentOfTwo } from "./thinEngine.pure-C50syCLt.js";
...
import { t as CubeMapToSphericalPolynomialTools } from "./cubemapToSphericalPolynomial-t9Qeowa_.js";
...
var EffectWrapper = class EffectWrapper {
	...
	*/
	...
	_postConstructor(blockCompilation, defines = null, extraInitializations, importPromises) {
		...
		if (this.options.useShaderStore && this._shaderPath.vertex === "postprocess") this._importPromises.push(useWebGPU && this._webGPUReady ? import("./postprocess.vertex-C7oWgBdt.js") : import("./postprocess.vertex-BTTp_qtT.js"));
	...
	return _a = class PostProcess {
		...
		*/
		...
		constructor(name, fragmentUrl, parameters, samplers, _size, camera, samplingMode = 1, engine, reusable, defines = null, textureType = 0, vertexUrl = "postprocess", indexParameters, blockCompilation = false, textureFormat = 5, shaderLanguage, extraInitializations) {
			...
			*/
			...
			if (parameters && !Array.isArray(parameters)) {
				...
				if (typeof _size === "number") size = _size;
				else size = {
					width: _size.width,
					height: _size.height
				};
		...
		_gatherImports(useWebGPU = false, list) {
			if (useWebGPU && this._webGPUReady) list.push(Promise.all([import("./postprocess.vertex-C7oWgBdt.js")]));
			else list.push(Promise.all([import("./postprocess.vertex-BTTp_qtT.js")]));
		}
		/**
...
async function _UploadLevelsAsync(texture, imageData, canGenerateNonLODTextures, imageType = DefaultEnvironmentTextureImageType) {
	if (!IsExponentOfTwo(texture.width)) throw new Error("Texture size must be a power of two");
	...
	if (expandTexture) {
		if (engine.isWebGPU) {
			shaderLanguage = 1;
			await import("./rgbdDecode.fragment-D3ArlV1e.js");
		} else await import("./rgbdDecode.fragment-fMOlsDNL.js");
			...
			for (let i = 0; i < mipSlices; i++) {
				...
				switch (i) {
					...
					case 1:
						...
						break;
					case 2: texture._lodTextureHigh = lodTexture;
				}
			}
		}
	}
	...
	if (imageData.length < mipmapsCount) {
		...
		switch (texture.type) {
			...
			case 2:
				...
				break;
			case 1: data = new Float32Array(dataLength);
		}
