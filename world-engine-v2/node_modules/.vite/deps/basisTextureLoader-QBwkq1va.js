...
import { c as InternalTexture } from "./thinEngine.pure-C50syCLt.js";
...
function workerFunction() {
	...
	*/
	function GetSupportedTranscodeFormat(config, fileInfo) {
		...
		if (config.supportedCompressionFormats) {
			if (config.supportedCompressionFormats.astc) format = _BASIS_FORMAT.cTFASTC_4x4;
	...
	*/
	function ConvertDxtToRgb565(src, srcByteOffset, width, height) {
		const c = /* @__PURE__ */ new Uint16Array(4);
...
var GetInternalFormatFromBasisFormat = (basisFormat, engine) => {
	...
	switch (basisFormat) {
		...
		case BASIS_FORMATS.cTFETC2:
			format = 37496;
			break;
		case BASIS_FORMATS.cTFBC7: format = 36492;
	}
