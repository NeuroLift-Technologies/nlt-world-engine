...
import { a as sceneUboDeclarationWGSL, i as meshUboDeclarationWGSL, n as mainUVVaryingDeclarationWGSL, r as defaultUboDeclarationWGSL, t as logDepthDeclarationWGSL } from "./logDepthDeclaration-Blp4DS8V.js";
...
var name$22 = "prePassDeclaration";
var shader$22 = `#ifdef PREPASS
...
var name$21 = "oitDeclaration";
var shader$21 = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
var name$20 = "lightUboDeclaration";
var shader$20 = `#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
var name$19 = "ltcHelperFunctions";
var shader$19 = `fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
var name$18 = "clusteredLightingFunctions";
var shader$18 = `struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/clusteredLightingCompute.js
var name$17 = "clusteredLightingCompute";
var shader$17 = `#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
var name$16 = "lightsFragmentFunctions";
var shader$16 = `struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
var name$15 = "shadowsFragmentFunctions";
var shader$15 = `#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
var name$14 = "samplerFragmentDeclaration";
var shader$14 = `#ifdef _DEFINENAME_
...
var name$13 = "fresnelFunction";
var shader$13 = `#ifdef FRESNEL
...
/** @internal */
var fresnelFunctionWGSL = {
	name: name$13,
	shader: shader$13
};
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/reflectionFunction.js
var name$12 = "reflectionFunction";
var shader$12 = `fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
var name$11 = "imageProcessingDeclaration";
var shader$11 = `#ifdef EXPOSURE
...
var name$10 = "imageProcessingFunctions";
var shader$10 = `#if TONEMAPPING==3
...
//#endregion
//#region node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/textureRepetitionFunctions.js
var name$9 = "textureRepetitionFunctions";
var shader$9 = `#if TEXTURE_REPETITION_MODE>0
...
var name$8 = "bumpFragmentMainFunctions";
var shader$8 = `#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
var name$7 = "bumpFragmentFunctions";
var shader$7 = `#if defined(BUMP)
...
var name$6 = "bumpFragment";
var shader$6 = `var uvOffset: vec2f= vec2f(0.0,0.0);
...
var name$5 = "decalFragment";
var shader$5 = `#ifdef DECAL
