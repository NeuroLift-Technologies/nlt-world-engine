import { s as Logger, t as RandomGUID } from "./guid-H658ONbr.js";
import { a as LoadImage } from "./fileTools.pure-Dhr2LAZd.js";
import { c as InternalTexture, s as AbstractEngine } from "./thinEngine.pure-C50syCLt.js";
import { t as _GetCompatibleTextureLoader } from "./textureLoaderManager-D7LREshn.js";
import { t as DDSTools } from "./dds.pure-Rk57pgXr.js";
...
//#endregion
//#region node_modules/@babylonjs/core/Engines/AbstractEngine/abstractEngine.cubeTexture.pure.js
	...
	AbstractEngine.prototype.createCubeTextureBase = function(rootUrl, scene, files, noMipmap, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = false, lodScale = 0, lodOffset = 0, fallback = null, beforeLoadCubeDataCallback = null, imageHandler = null, useSRGBBuffer = false, buffer = null) {
		...
		if (loaderPromise) loaderPromise.then((loader) => {
			...
			if (buffer) onLoadData(buffer);
				...
				if (loader.supportCascades) this._cascadeLoadFiles(scene, (images) => onLoadData(images.map((image) => new Uint8Array(image))), files, localOnError);
