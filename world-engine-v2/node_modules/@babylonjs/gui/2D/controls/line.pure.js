...
import { Vector3, Matrix } from "@babylonjs/core/Maths/math.vector.pure.js";
...
let Line = (() => {
    ...
    let _get_dash_decorators;
    let _get_x1_decorators;
    let _get_y1_decorators;
    let _get_x2_decorators;
    let _get_y2_decorators;
    let _get_lineWidth_decorators;
    return _a = class Line extends _classSuper {
            ...
            set connectedControl(value) {
                ...
                if (this._connectedControl === value || (value instanceof _a && value._connectedControl === this)) {
                    return;
                }
        ...
        (() => {
            ...
            _get_dash_decorators = [serialize()];
            _get_x1_decorators = [serialize()];
            _get_y1_decorators = [serialize()];
            _get_x2_decorators = [serialize()];
            _get_y2_decorators = [serialize()];
            _get_lineWidth_decorators = [serialize()];
            __esDecorate(_a, null, _get_dash_decorators, { kind: "getter", name: "dash", static: false, private: false, access: { has: obj => "dash" in obj, get: obj => obj.dash }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(_a, null, _get_x1_decorators, { kind: "getter", name: "x1", static: false, private: false, access: { has: obj => "x1" in obj, get: obj => obj.x1 }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(_a, null, _get_y1_decorators, { kind: "getter", name: "y1", static: false, private: false, access: { has: obj => "y1" in obj, get: obj => obj.y1 }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(_a, null, _get_x2_decorators, { kind: "getter", name: "x2", static: false, private: false, access: { has: obj => "x2" in obj, get: obj => obj.x2 }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(_a, null, _get_y2_decorators, { kind: "getter", name: "y2", static: false, private: false, access: { has: obj => "y2" in obj, get: obj => obj.y2 }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(_a, null, _get_lineWidth_decorators, { kind: "getter", name: "lineWidth", static: false, private: false, access: { has: obj => "lineWidth" in obj, get: obj => obj.lineWidth }, metadata: _metadata }, null, _instanceExtraInitializers);
...
//# sourceMappingURL=line.pure.js.map