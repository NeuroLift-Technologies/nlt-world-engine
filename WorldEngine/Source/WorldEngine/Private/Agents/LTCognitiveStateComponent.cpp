...
{
    // Apply coaching effect based on strategy
    switch (StrategyId)
    {
    case 1: // Pomodoro
    ...
    case 3: // BodyDouble
        ...
        break;
    case 4: // ImplementationIntent
        CognitiveLoad = FMath::Max(0.0f, CognitiveLoad - 0.05f);
        Focus = FMath::Min(1.0f, Focus + 0.1f);
        break;
    case 5: // TwoMinuteStart
    ...
    case 6: // TaskChunking
        ...
        Focus = FMath::Min(1.0f, Focus + 0.05f);
        break;
    case 7: // MindfulRefocus
        Stress = FMath::Max(0.0f, Stress - 0.2f);
        Focus = FMath::Min(1.0f, Focus + 0.1f);
        break;
    case 8: // DistractionImmunize
        Focus = FMath::Min(1.0f, Focus + 0.15f);
        break;
    case 9: // AttentionAnchor
        Focus = FMath::Min(1.0f, Focus + 0.2f);
        Stress = FMath::Max(0.0f, Stress - 0.1f);
        break;
    case 10: // ShrinkTheTask
