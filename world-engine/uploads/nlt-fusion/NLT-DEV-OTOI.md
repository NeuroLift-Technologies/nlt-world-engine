# NLT-DEV-OTOI — nlt-fusion Developer Operations & Team Orientation Index

**Document ID:** ORG-DEV-OTOI-1.0.0  
**Scope:** Repository-specific (NeuroLift-Technologies/nlt-fusion)  
**Repository:** `NeuroLift-Technologies/nlt-fusion`  
